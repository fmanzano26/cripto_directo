...
// Se define la variable contador para el número de veces que se actualiza el precio de la criptomoneda
...
function procesarNuevoMensaje(mensaje) {
  ...
  // Se suman las modificaciones del precio de la criptomoneda
...
var contexto3 = document.getElementById('contexto3');
var contexto4 = document.getElementById('contexto4');
var contexto5 = document.getElementById('contexto5');
...
var ancho = 860 - margen.left - margen.right;
...
function actualizar(objetoMoneda) {
  ...
  if (precioInicial < objetoMoneda.precioActual) {
    ...
    contexto2.innerText = 'Variación frente al último dato: Subió + ' + formatoUSD.format(diferencia);
  } else if (precioInicial > objetoMoneda.precioActual) {
    var diferencia = precioInicial - objetoMoneda.precioActual;
    contexto2.innerText = 'Variación frente al último dato: Bajó - ' + formatoUSD.format(diferencia);
  } else {
    contexto2.innerText = 'Variación frente al último dato: Igual = 0';
  }

  // Incluyo fecha actual de la visualización
  
  var fecha_actual = new Date(Date.now());
  contexto3.innerText = 'Fecha actual: '+ fecha_actual.toString()

// Incluyo el número de veces que se actualiza el precio
  contexto4.innerText = 'Variaciones de precio desde la conexión: ' + contador
  
  contexto5.innerText = menu.value;
